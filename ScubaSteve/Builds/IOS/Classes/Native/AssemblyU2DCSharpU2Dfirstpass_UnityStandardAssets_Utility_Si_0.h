...
struct SimpleMouseRotator_t358  : public MonoBehaviour_t39
{
	// UnityEngine.Vector2 UnityStandardAssets.Utility.SimpleMouseRotator::rotationRange
	Vector2_t177  ___rotationRange_2;
