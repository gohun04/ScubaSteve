...
void g_System_Core_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AssemblyTitleAttribute__ctor_m4440(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyTitleAttribute__ctor_m4440_MethodInfo);
	...
	}
	{
		...
		AssemblyDefaultAliasAttribute__ctor_m6625(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyDefaultAliasAttribute__ctor_m6625_MethodInfo);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m4441(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyDescriptionAttribute__ctor_m4441_MethodInfo);
