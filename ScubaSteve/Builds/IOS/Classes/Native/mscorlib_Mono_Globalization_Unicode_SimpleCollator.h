...
struct SimpleCollator_t1903  : public Object_t
{
	...
	CodePointIndexer_t1888 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1888 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1903_StaticFields{
	...
	SimpleCollator_t1903 * ___invariant_1;
};
